...
public class DataLogger implements Serializable {
	...
	//bi-directional many-to-one association to DataLoggerExtraInfo
	@OneToMany(mappedBy="dataLogger")
	private List<DataLoggerExtraInfo> dataLoggerExtraInfos;
	...
	public List<DataLoggerExtraInfo> getDataLoggerExtraInfos() {
		return this.dataLoggerExtraInfos;
	}

	public void setDataLoggerExtraInfos(List<DataLoggerExtraInfo> dataLoggerExtraInfos) {
		this.dataLoggerExtraInfos = dataLoggerExtraInfos;
	}

	public DataLoggerExtraInfo addDataLoggerExtraInfo(DataLoggerExtraInfo dataLoggerExtraInfo) {
		getDataLoggerExtraInfos().add(dataLoggerExtraInfo);
		dataLoggerExtraInfo.setDataLogger(this);

		return dataLoggerExtraInfo;
	}

	public DataLoggerExtraInfo removeDataLoggerExtraInfo(DataLoggerExtraInfo dataLoggerExtraInfo) {
		getDataLoggerExtraInfos().remove(dataLoggerExtraInfo);
		dataLoggerExtraInfo.setDataLogger(null);
